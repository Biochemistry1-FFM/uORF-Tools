...
rule trim:
    ...
    threads: 1
    shell:
        "mkdir -p trimmed; trim_galore {params.ada} --phred33 --length 15 --output_dir trimmed/ --trim-n --suppress_warn --dont_gzip fastq/{params.prefix}.fastq.gz; mv trimmed/{params.prefix}_trimmed.fq {output}"
