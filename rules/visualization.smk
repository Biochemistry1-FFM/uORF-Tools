...
rule annotationBigBed:
    ...
    threads: 1
    shell:
        "mkdir -p tracks; cut -f1-6 {input[0]} > tracks/annotation.bed6;  awk -F $'\\t' 'BEGIN {{OFS = FS}} {{$5=1 ; print ;}}' tracks/annotation.bed6 > tracks/annotationScore.bed6; bedToBigBed -type=bed6 -tab tracks/annotationScore.bed6 {input[1]} tracks/annotation.bb; rm tracks/annotationScore.bed6;"
