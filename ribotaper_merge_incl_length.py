...
'''This script takes n number of input files generated by ribotaper and creates a new data frame containing only the uORF information. The input must be in the form <file1> <file2> <file3> ... min_length max_length. The resulting data frame is stored as csv file

- mammalian uORF length at least 9nt (https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2669787/)
- Should we set (min/)max length? --> (https://link.springer.com/content/pdf/10.1186/1471-2164-10-162.pdf)'''
