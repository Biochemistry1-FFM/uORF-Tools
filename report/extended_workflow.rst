`uORF-Tools <https://github.com/Biochemistry1-FFM/uORF-Tools>`_ extended workflow performs a analysis of upstream open reading frames (uORF) from ribosome profiling and optionally RNA-seq high troughput sequencing data. The data is processed in the following steps.
